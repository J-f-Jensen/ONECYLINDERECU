...
/*Analog Signal Definitions********************************************************/
  ...
  //Lean angle CUT off(TILT)
  //Define the signal for the system to enable functionality.
  //#define TILT
  //Define for TILT filter algorithm selection.  Only average is available.
  //Leave undefined for using raw data only. 
  //#define TILT_AVERAGE_FILTER
  //Data collection periodic rate can be from 1 - 255ms.
  //#define TILT_DATA_COLLECTION_RATE 16
  // TILT data buffer size 
  //#define TILT_BUFFER_SIZE 16
